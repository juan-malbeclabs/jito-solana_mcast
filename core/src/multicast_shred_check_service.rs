...
/// Multicast group for shreds forwarded at the turbine root (`root_distance == 0`).
/// This is intentionally distinct from the leader-broadcast group above so that
/// root-forwarded shreds and the leader's own shreds never share a group.
...
pub fn multicast_addresses_for_cluster(
